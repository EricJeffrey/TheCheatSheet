...
bsoncxx::document::view_or_value toMongoDoc(const CodeSegment &codeSegment, bool ignoreId = true);
bsoncxx::document::view_or_value toMongoDoc(const User &user, bool ignoreId = true);
bsoncxx::document::view_or_value toMongoDoc(const Tag &tag, bool ignoreId = true);
